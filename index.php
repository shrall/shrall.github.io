...
<!-- saved from url=(0065)file:///C:/Users/a/Desktop/Prank%20Call%20Online%20Indonesia.html -->
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><link rel="preload" href="./Prank Call Online Indonesia_files/f(2).txt" as="script"><script src="f.txt" id="google_shimpl"></script><script src="osd.js.download"></script><script src="f(1).txt" id="google_shimpl"></script><script type="text/javascript" src="f(2).txt"></script><link rel="preload" href="f(3).txt" as="script"><script type="text/javascript" src="f(3).txt"></script><link rel="preload" href="f(1).txt" as="script"><link rel="preload" href="f(4).txt" as="script"><script type="text/javascript" src="f(4).txt"></script><link rel="preload" href="f(5).txt" as="script"><script type="text/javascript" src="f(5).txt"></script><link rel="preload" href="f.txt" as="script"></head><body>
  <link rel="stylesheet" href="bootstrap.min.css">
 <script src="jquery.min.js.download"></script>
 <script src="popper.min.js.download"></script>
 <script src="bootstrap.min.js.download"></script>
<meta name="viewport" content="user-scalable=no,initial-scale=1,maximum-scale=1">
<link rel="stylesheet" href="bootstrap.min(1).css" integrity="sha384-BVYiiSIFeK1dGmJRAkycuHAHRg32OmUcww7on3RYdg4Va+PmSTsz/K68vbdEjh4u" crossorigin="anonymous">
 <style type="text/css">
...
<title>Prank Call Online Indonesia</title>
<link rel="stylesheet" href="style.css" type="text/css">


<style type="text/css">
    .formBom{margin-top: 50px; border-radius: 5px;} .headerForm{background-color:#B8860B; color: #fff;padding: 10px 0; font-weight: 1000; margin-bottom: 20px;} body{background:#2C3E50; background-size: cover;} .formBody{background-color: #fff;padding: 10px 20px;} .formBom {background-color: #fff;} form {} button {width: 100%; background-color:#2C3E50; color: #fff;}  .btn:hover {background-color:#B8860B; color: #fff;}
</style>
<script async="" src="f(6).txt"></script>



    <div class="container" style="height: auto !important;">
        <div class="col-md-4"></div>
        <div class="col-md-4" style="height: auto !important; min-height: 0px !important;">
            <div class="formBom" style="height: auto !important;">
                <div class="headerForm">
                    <h2 class="text-center">PRANK CALL</h2>
                </div>
                <div class="formBody" style="height: auto !important;">
                       <div class="alert alert-info"><strong>Informasi!</strong>
    <br>Semua operator
    <br>Limit 3x/Jam
    ...
    <br>-Shrall
         ...
         <form method="POST" action=index.php">
                      ...
                      <button type="submit" class="btn" name="CALL">CALL !</button>
                    </form>              
                    <br>
                 <script async="" src="f(6).txt"></script>
...
</div></div></div></div><iframe id="google_osd_static_frame_8346875008048" name="google_osd_static_frame" __idm_frm__="15" style="display: none; width: 0px; height: 0px;" src="saved_resource(3).html"></iframe><iframe id="google_esf" name="google_esf" src="zrt_lookup.html" data-ad-client="ca-pub-6368709975044652" style="display: none;"></iframe><iframe id="google_osd_static_frame_9391195158378" name="google_osd_static_frame" style="display: none; width: 0px; height: 0px;" src="saved_resource.html"></iframe></body></html>